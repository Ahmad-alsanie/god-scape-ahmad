...
@Singleton
public class OsrsLoadoutsMeleeEquipmentPanel extends JPanel {

    private static volatile OsrsLoadoutsMeleeEquipmentPanel instance;
    ...
    public OsrsLoadoutsMeleeEquipmentPanel() {
