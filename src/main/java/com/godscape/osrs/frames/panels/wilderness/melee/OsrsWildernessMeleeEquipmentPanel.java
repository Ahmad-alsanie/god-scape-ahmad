...
@Singleton
public class OsrsWildernessMeleeEquipmentPanel extends JPanel {

    private static volatile OsrsWildernessMeleeEquipmentPanel instance;
    ...
    public OsrsWildernessMeleeEquipmentPanel() {
