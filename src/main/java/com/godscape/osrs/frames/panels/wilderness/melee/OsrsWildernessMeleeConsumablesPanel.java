package com.godscape.osrs.frames.panels.wilderness.melee;
...
@Singleton
public class OsrsWildernessMeleeConsumablesPanel extends JPanel {

    private static volatile OsrsWildernessMeleeConsumablesPanel instance;
    ...
    public OsrsWildernessMeleeConsumablesPanel() {
