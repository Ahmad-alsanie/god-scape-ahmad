...
@Singleton
public class OsrsWildernessMagicConsumablesPanel extends JPanel {

    private static volatile OsrsWildernessMagicConsumablesPanel instance;
    ...
    public OsrsWildernessMagicConsumablesPanel() {
