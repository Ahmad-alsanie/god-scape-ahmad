...
@Singleton
public class OsrsLoadoutsMagicEquipmentPanel extends JPanel {

    private static volatile OsrsLoadoutsMagicEquipmentPanel instance;
    ...
    public OsrsLoadoutsMagicEquipmentPanel() {
        ...
        osrsGridBuilder = new OsrsGridBuilder(OsrsPanels.OSRS_LOADOUTS_MAGIC_EQUIPMENT_PANEL);

        try {
            Logger.info("Attempting to initialize PanelGrid within OsrsLoadoutsMagicEquipmentPanel...");
            ...
            osrsGridBuilder.addSeparator("Magic Equipment Loadout");
            ...
            Logger.info("PanelGrid added to OsrsLoadoutsMagicEquipmentPanel layout successfully.");
        } catch (Exception e) {
            Logger.error("Error initializing PanelGrid in OsrsLoadoutsMagicEquipmentPanel: {}", e.getMessage());
            e.printStackTrace();
        }
    }
