...
@Singleton
public class OsrsWildernessDragonsEquipmentPanel extends JPanel {

    private static volatile OsrsWildernessDragonsEquipmentPanel instance;
    ...
    public OsrsWildernessDragonsEquipmentPanel() {
        ...
        osrsGridBuilder = new OsrsGridBuilder(OsrsPanels.OSRS_WILDERNESS_DRAGONS_EQUIPMENT_PANEL);

        try {
            Logger.info("Attempting to initialize PanelGrid within OsrsWildernessDragonsEquipmentPanel...");
            ...
            osrsGridBuilder.addSeparator("Wilderness Dragon-Fighting Equipment Loadout");
            ...
            Logger.info("PanelGrid added to OsrsWildernessDragonsEquipmentPanel layout successfully.");
        } catch (Exception e) {
            Logger.error("Error initializing PanelGrid in OsrsWildernessDragonsEquipmentPanel: {}", e.getMessage());
            e.printStackTrace();
        }
    }
