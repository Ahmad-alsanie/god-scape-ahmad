...
@Singleton
public class OsrsWildernessRangedEquipmentPanel extends JPanel {

    private static volatile OsrsWildernessRangedEquipmentPanel instance;
    ...
    public OsrsWildernessRangedEquipmentPanel() {
        ...
        try {
            Logger.info("Initializing PanelGrid in OsrsWildernessMeleeEquipmentPanel...");
            ...
            osrsGridBuilder.addSeparator("Wilderness Melee Equipment Loadout");
