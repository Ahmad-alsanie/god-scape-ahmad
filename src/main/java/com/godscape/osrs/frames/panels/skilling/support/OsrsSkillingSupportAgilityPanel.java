...
@Singleton
public class OsrsSkillingSupportAgilityPanel extends JPanel {
    ...
    public OsrsSkillingSupportAgilityPanel() {
        ...
        try {
            ...
            List<String> gracefulPreference = Arrays.asList("Auto", "Disabled", "Arceus", "Hosidius", "Lovakengj", "Piscarilius", "Shayzien");
            ...
            osrsGridBuilder.addLabel(1, "Graceful Preference:");
            osrsGridBuilder.addDropdown(2, "agilitySettings", "gracefulPreference", gracefulPreference, OsrsSchemas.OSRS_PROFILE_SCHEMA);
            osrsGridBuilder.nextRow();

            osrsGridBuilder.addLabel(1, "Graceful Outfit:");
            osrsGridBuilder.addObtainbox(2, "agilitySettings", "obtainGraceful", OsrsSchemas.OSRS_PROFILE_SCHEMA);
            osrsGridBuilder.addLabel(3, "← ← Zeah:");
            osrsGridBuilder.addObtainbox(4, "agilitySettings", "blackGraceful", OsrsSchemas.OSRS_PROFILE_SCHEMA);
            osrsGridBuilder.nextRow();

            osrsGridBuilder.addLabel(1, "Arena Outfit");
            osrsGridBuilder.addObtainbox(2, "agilitySettings", "arenaGraceful", OsrsSchemas.OSRS_PROFILE_SCHEMA);
            osrsGridBuilder.addLabel(3, "Hallowed Outfit");
            osrsGridBuilder.addObtainbox(4, "agilitySettings", "arenaGraceful", OsrsSchemas.OSRS_PROFILE_SCHEMA);
            osrsGridBuilder.nextRow();

            osrsGridBuilder.addLabel(1, "Trailblazer Outfit");
            osrsGridBuilder.addObtainbox(2, "agilitySettings", "arenaGraceful", OsrsSchemas.OSRS_PROFILE_SCHEMA);
            osrsGridBuilder.addLabel(3, "Adventurer's Outfit");
            osrsGridBuilder.addObtainbox(4, "agilitySettings", "arenaGraceful", OsrsSchemas.OSRS_PROFILE_SCHEMA);
            osrsGridBuilder.nextRow();

            osrsGridBuilder.addLabel(1, "Colossal Wyrm Outfit");
            osrsGridBuilder.addObtainbox(2, "agilitySettings", "arenaGraceful", OsrsSchemas.OSRS_PROFILE_SCHEMA);
            osrsGridBuilder.nextRow();
