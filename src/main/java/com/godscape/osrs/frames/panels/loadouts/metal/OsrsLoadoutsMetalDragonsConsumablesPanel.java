package com.godscape.osrs.frames.panels.loadouts.metal;
...
@Singleton
public class OsrsLoadoutsMetalDragonsConsumablesPanel extends JPanel {

    private static volatile OsrsLoadoutsMetalDragonsConsumablesPanel instance;
    ...
    public OsrsLoadoutsMetalDragonsConsumablesPanel() {
        ...
        osrsGridBuilder = new OsrsGridBuilder(OsrsPanels.OSRS_LOADOUTS_METAL_DRAGONS_CONSUMABLES_PANEL);

        try {
            Logger.info("Attempting to initialize PanelGrid within OsrsLoadoutsMetalDragonsConsumablesPanel...");
            ...
            // Potions and items commonly used for metal dragons in a 4-column grid format
            ...
            Logger.info("PanelGrid added to OsrsLoadoutsMetalDragonsConsumablesPanel layout successfully.");
        } catch (Exception e) {
            Logger.error("Error initializing PanelGrid in OsrsLoadoutsMetalDragonsConsumablesPanel: {}", e.getMessage());
            e.printStackTrace();
        }
    }
