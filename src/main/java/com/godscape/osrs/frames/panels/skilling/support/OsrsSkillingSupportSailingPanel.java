...
@Singleton
public class OsrsSkillingSupportSailingPanel extends JPanel {
    ...
    public OsrsSkillingSupportSailingPanel() {
        ...
        try {
            ...
            List<String> trainingMethod = Arrays.asList("Auto", "Rooftop Course", "Wilderness Course", "Agility Pyramid", "Barbarian Outpost", "Gnome Stronghold", "Ape Atoll", "Dorgesh-Kaan", "Werewolf", "Hefin", "Prifddinas");

            osrsGridBuilder.addSeparator("Agility Settings");
            osrsGridBuilder.nextRow();

            // Add configurations to the grid
            osrsGridBuilder.addLabel(1, "<html><u>Skill currently unavailable</u></html>");
            osrsGridBuilder.nextRow();
